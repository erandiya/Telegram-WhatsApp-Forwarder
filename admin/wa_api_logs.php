...
<body class="bg-[#060912] text-gray-200 font-sans">
    ...
    <div id="main-content" class="main-content">
        <div class="max-w-7xl mx-auto">
            <header class="flex items-center justify-between mb-8">
                ...
                <button onclick="clearPM2('whatsapp-api')" class="bg-red-500/10 text-red-500 border border-red-500/20 px-4 py-2 rounded-xl text-xs font-bold hover:bg-red-500 hover:text-white transition-all">Flush Logs</button>
            </header>
    ...
    function fetchLogs() {
        ...
        fetch(`api_pm2_logs.php?app=whatsapp-api&search=${encodeURIComponent(search)}`)
            .then(res => res.json())
            .then(data => {
                let html = '';
                data.forEach(log => {
